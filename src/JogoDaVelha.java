...
public class JogoDaVelha extends JFrame {
	...
	JLabel lInformação = new JLabel("Jogador " + JOGADOR_1);
	...
	public void configurarTela() {
		...
		add(BorderLayout.NORTH, lInformação);
		pTela.setBackground(Color.BLACK);
		lInformação.setFont(new Font("Arial", Font.BOLD, 30));
		lInformação.setForeground(new Color(50, 200, 50));
		lInformação.setHorizontalAlignment(SwingConstants.CENTER);
	...
	public void mudarVez() {
		if (jogadorVez == 1) {
			jogadorVez = 2;
			lInformação.setText("Jogador 2");
			lInformação.setForeground(Color.RED);
		} else {
			jogadorVez = 1;
			lInformação.setText("Jogador 1");
			lInformação.setForeground(new Color(50, 200, 50));
		}
	}
